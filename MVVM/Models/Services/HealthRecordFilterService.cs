...
{
    internal class HealthRecordFilterService : IHealthRecordFilterService
    {
        //public List<Patient> ApplyFilters(
        ...
        //            (r.Name?.ToLowerInvariant().Contains(normalized, StringComparison.InvariantCultureIgnoreCase) ?? false) ||
